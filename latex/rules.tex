...
\usepackage[paperwidth=6.3in,paperheight=6.1in,margin=0.1in]{geometry}
...
\\
  \trfrac
  {\Gamma \vdash c \vdash \bar{x} : \tau_1, \bar{y} : \tau_2, \bar{\Gamma}}
  {\Gamma \vdash \text{comatch-par}\,\bar{x}\,\bar{y}.\,c \vdash \langle\tau_1 \parr \tau_2\rangle; \bar{\Gamma}}
  &
  \trfrac
  {
